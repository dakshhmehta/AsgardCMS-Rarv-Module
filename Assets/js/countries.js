...
function populateStates(countryElementId, stateElementId, state) {
...
function populateCountries(countryElementId, stateElementId, country, state) {
    ...
    for (var i = 0; i < country_arr.length; i++) {
        ...
        if(country == country_arr[i]){
        	console.log(country_arr[i] + '-' + i+1);
        	countryElement.selectedIndex = i+1;
            populateStates(countryElementId, stateElementId, state);
		}
    }
